...
To build the final jar and optimize the ehs application for production, run:
...
Note: we have turned off authentication in [src/main/docker/sonar.yml](src/main/ehs-docker/sonar.yml) for out of the box experience while trying out SonarQube, for real use cases turn it back on.
...
You can use Docker to improve your JHipster development experience. A number of docker-compose configuration are available in the [src/main/docker](src/main/ehs-docker) folder to launch required third party services.
