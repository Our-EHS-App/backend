...
class CategoryResourceIT {
    ...
    private static final Boolean DEFAULT_IS_SUB_CATEGORY = false;
    private static final Boolean UPDATED_IS_SUB_CATEGORY = true;
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().nameAr(DEFAULT_NAME_AR).nameEn(DEFAULT_NAME_EN).isSubCategory(DEFAULT_IS_SUB_CATEGORY);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().nameAr(UPDATED_NAME_AR).nameEn(UPDATED_NAME_EN).isSubCategory(UPDATED_IS_SUB_CATEGORY);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getNameAr()).isEqualTo(DEFAULT_NAME_AR);
        assertThat(testCategory.getNameEn()).isEqualTo(DEFAULT_NAME_EN);
        assertThat(testCategory.getIsSubCategory()).isEqualTo(DEFAULT_IS_SUB_CATEGORY);
    }
    ...
    void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.[*].isSubCategory").value(hasItem(DEFAULT_IS_SUB_CATEGORY.booleanValue())));
    }
    ...
    void getCategory() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.isSubCategory").value(DEFAULT_IS_SUB_CATEGORY.booleanValue()));
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.nameAr(UPDATED_NAME_AR).nameEn(UPDATED_NAME_EN).isSubCategory(UPDATED_IS_SUB_CATEGORY);
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getNameAr()).isEqualTo(UPDATED_NAME_AR);
        assertThat(testCategory.getNameEn()).isEqualTo(UPDATED_NAME_EN);
        assertThat(testCategory.getIsSubCategory()).isEqualTo(UPDATED_IS_SUB_CATEGORY);
    }
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.nameAr(UPDATED_NAME_AR);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.nameAr(UPDATED_NAME_AR).nameEn(UPDATED_NAME_EN).isSubCategory(UPDATED_IS_SUB_CATEGORY);
