...
class LocationResourceIT {
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().nameAr(DEFAULT_NAME_AR).nameEn(DEFAULT_NAME_EN);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().nameAr(UPDATED_NAME_AR).nameEn(UPDATED_NAME_EN);
        return location;
    }
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getNameAr()).isEqualTo(DEFAULT_NAME_AR);
        assertThat(testLocation.getNameEn()).isEqualTo(DEFAULT_NAME_EN);
    }
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.nameAr(UPDATED_NAME_AR).nameEn(UPDATED_NAME_EN);
        ...
        Location testLocation = locationList.get(locationList.size() - 1);
        assertThat(testLocation.getNameAr()).isEqualTo(UPDATED_NAME_AR);
        assertThat(testLocation.getNameEn()).isEqualTo(UPDATED_NAME_EN);
    }
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.nameAr(UPDATED_NAME_AR);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.nameAr(UPDATED_NAME_AR).nameEn(UPDATED_NAME_EN);
